...
#-----------------------------------------------------#
class Architecture_EfficientNetB4(Architecture_Base):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    def __init__(self, classification_head, channels, input_shape=(380, 380),
    ...
    def create_model(self):
        ...
        base_model = EfficientNetB4(include_top=False, weights=model_weights,
