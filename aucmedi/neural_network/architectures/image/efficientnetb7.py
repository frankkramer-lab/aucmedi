...
#-----------------------------------------------------#
class Architecture_EfficientNetB7(Architecture_Base):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    def __init__(self, classification_head, channels, input_shape=(600, 600),
    ...
    def create_model(self):
        ...
        base_model = EfficientNetB7(include_top=False, weights=model_weights,
