...
Choose pretrained weights via the torchvision `ViT_B_32_Weights` enum and use
the `get_preprocess()` helper to obtain the correct preprocessing transforms.

???+ abstract "Reference - Implementation"
  [https://docs.pytorch.org/vision/main/models/generated/torchvision.models.vit_b_32.html](https://docs.pytorch.org/vision/main/models/generated/torchvision.models.vit_b_32.html) <br>
...
# -----------------------------------------------------#
# External libraries
from torchvision.models import vit_b_32 as TorchvisionModel
...
class ViT_B32(Architecture_Base):
    ...
    def create_model(self):
        if self.pretrained_weights:
            weights_arg = ViT_B_32_Weights.DEFAULT
        else:
            weights_arg = None
