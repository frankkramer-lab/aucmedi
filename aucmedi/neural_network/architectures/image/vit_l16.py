...
Choose pretrained weights via the torchvision `ViT_L_16_Weights` enum and use
the `get_preprocess()` helper to obtain the correct preprocessing transforms.

???+ abstract "Reference - Implementation"
  [https://docs.pytorch.org/vision/main/models/generated/torchvision.models.vit_l_16.html](https://docs.pytorch.org/vision/main/models/generated/torchvision.models.vit_l_16.html) <br>
...
# -----------------------------------------------------#
class ViT_L16(Architecture_Base):
    ...
    def get_output_shape(self):
        # ViT-L embed dim is 1024 exposed as (1,1,channels)
        return (1, 1, 1024)
    ...
    def create_model(self):
        if self.pretrained_weights:
            weights_arg = ViT_L_16_Weights.DEFAULT
        else:
            weights_arg = None
