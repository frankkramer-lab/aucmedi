...
Methods:
    ...
    create_model:           Creating the NASNetMobile model for classification
"""
class Architecture_NASNetMobile(Architecture_Base):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    ...
    def create_model(self, n_labels, fcl_dropout=True, out_activation="softmax",
        ...
        base_model = NASNetMobile(include_top=False, weights=model_weights,
