...
Methods:
    ...
    create_model:           Creating the ResNet101V2 model for classification
"""
class Architecture_ResNet101V2(Architecture_Base):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    ...
    def create_model(self, n_labels, fcl_dropout=True, out_activation="softmax",
        ...
        base_model = ResNet101V2(include_top=False, weights=model_weights,
