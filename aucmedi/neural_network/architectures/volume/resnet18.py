...
Methods:
    ...
    create_model:           Creating the ResNet18 model for classification
"""
class Architecture_ResNet18(Architecture_Base):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    ...
    def create_model(self, n_labels, fcl_dropout=True, out_activation="softmax",
        ...
        base_model = ResNet18(include_top=False, weights=model_weights,
