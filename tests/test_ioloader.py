...
class IOloaderTEST(unittest.TestCase):
    ...
    #                  Image Loader                   #
    # -------------------------------------------------#
    # Test for DataLoader functionality
    def test_image_loader_DataLoader(self):
        ...
        for batch in data_loader:
            if i >= 3:
                break
            i += 1
            self.assertTrue(np.array_equal(batch.shape, (2, 16, 16, 3)))
    ...
    def test_image_loader_2Dgray(self):
        ...
        for i in range(0, 5):
            ...
            img = image_loader(index, tmp_data.name, image_format=None, grayscale=True)
    ...
    def test_image_loader_2Drgb(self):
        ...
        for i in range(0, 5):
            ...
            img_pillow.save(path_sample)
            # Load image via loader
            img = image_loader(index, tmp_data.name, image_format=None, grayscale=False)
    ...
    # -------------------------------------------------#
    # Test for DataLoader functionality
    def test_numpy_loader_DataLoader(self):
        # Create temporary directory
        tmp_data = tempfile.TemporaryDirectory(prefix="tmp.aucmedi.", suffix=".data")
        # Create dataset
        sample_list = []
        ...
        for batch in data_loader:
            if i >= 3:
                break
            i += 1
            self.assertTrue(np.array_equal(batch.shape, (2, 16, 16, 16, 1)))
    ...
    def test_numpy_loader_2Dgray(self):
        ...
        for i in range(0, 5):
            ...
            # Load image via loader
            img = numpy_loader(
                index, tmp_data.name, image_format=None, grayscale=True, two_dim=True
            )
            self.assertTrue(np.array_equal(img.shape, self.img_2d_gray.shape))
    ...
    def test_numpy_loader_3Dgray(self):
        ...
        for i in range(0, 5):
            ...
            # Load image via loader
            img = numpy_loader(
                index, tmp_data.name, image_format=None, grayscale=True, two_dim=False
            )
    ...
    def test_numpy_loader_2Drgb(self):
        ...
        for i in range(0, 5):
            ...
            # Load image via loader
            img = numpy_loader(
                index, tmp_data.name, image_format=None, grayscale=False, two_dim=True
            )
            self.assertTrue(np.array_equal(img.shape, self.img_2d_rgb.shape))
    ...
    def test_numpy_loader_3Drgb(self):
        ...
        for i in range(0, 5):
            ...
            # Load image via loader
            img = numpy_loader(
                index, tmp_data.name, image_format=None, grayscale=False, two_dim=False
            )
    ...
    # -------------------------------------------------#
    # Test for DataLoader functionality
    def test_sitk_loader_DataLoader(self):
        # Create temporary directory
        tmp_data = tempfile.TemporaryDirectory(prefix="tmp.aucmedi.", suffix=".data")
        # Create mha dataset
        sample_list = []
        ...
        for i, batch in enumerate(data_loader):
            if i < 3:
                self.assertTrue(np.array_equal(batch.shape, (1, 32, 24, 8, 1)))
            else:
                self.assertTrue(np.array_equal(batch.shape, (1, 12, 20, 28, 1)))
    ...
    def test_sitk_loader_Resampling(self):
        ...
        for index in sample_list:
            img = sitk_loader(
                index, tmp_data.name, image_format=None, resampling=(2.0, 0.5, 0.5)
            )
        ...
        for batch in data_loader:
            if i >= 6:
                break
            self.assertTrue(np.array_equal(batch.shape, (1, 18, 10, 10, 1)))

    # -------------------------------------------------#
    #                  Cache Loader                   #
    # -------------------------------------------------#
    # Test for DataLoader functionality
    def test_cache_loader_DataLoader(self):
        # Create temporary directory
        tmp_data = tempfile.TemporaryDirectory(prefix="tmp.aucmedi.", suffix=".data")
        # Create dataset
        sample_list = []
